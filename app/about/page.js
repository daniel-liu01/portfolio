    ...
    <div>
      ...
      <main className={styles.aboutMain}>
        ...
        <div className={styles.heroDownWrap}>
          <a
            href="#small-joys"
            className={styles.heroDown}
            aria-label="Scroll to Small Joys section"
          >
        ...
        >
          <section
            id="small-joys"
            className={styles.smallJoys}
            aria-label="Small joys"
          >
            ...
            <div className={styles.smallJoysCloud}>
              ...
              >
                <span className={`${styles.smallJoy} ${styles.smallJoyMedium}`}>
                  Music
                </span>
              </span>
              <span
              ...
              <div className={styles.contactCollage}>
                <div className={styles.contactPlaceholder}>
                  <img
                    src="/about/1.jpeg"
                    alt=""
                    className={styles.contactCollageImg}
                  />
                </div>
                <div className={styles.contactPlaceholder}>
                  <img
