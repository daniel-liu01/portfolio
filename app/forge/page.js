...
const forgeContent = {
  ...
  meta: [
    ...
    { label: "Focus", value: "UX Design/Research" },
  ],
};
    ...
    <div>
      ...
      <main className={styles.main}>
        ...
        >
          ...
          >
            <p>
              I quickly made these mockups, a{" "}
              <strong>business dashboard</strong> doubling as a{" "}
              <strong>step by step guide</strong> to building a business. We
              were excited, convinced this is the idea going forward.
            </p>
          </ContentSection>
        </ScrollFade>
        <ScrollFade
        ...
        >
          ...
          >
            ...
            <p>
              ...
              back to brainstorming. We identified a gap in studying apprentices
              due to challenges like school/work, financial pressure, and
        ...
        >
          <ContentSection title="Assumption" variant="textRight">
            ...
            <p>
              ...
              for apprentice, there is potential for high school students to
              come in and fill the upcoming labour shortage.
            </p>
          </ContentSection>
        </ScrollFade>
        <ScrollFade
        ...
        >
          ...
          >
            <p>
              ...
              understand their concerns and motivations regarding skilled
              trades. We had 9 respondents in total.
            </p>
          </ContentSection>
        </ScrollFade>
        <ScrollFade
        ...
        >
          <ContentSection title="Feedback" variant="textRight">
            <p>
              ...
              <br />
              <br />I immediately thought of Duolingo and how colorful and fun
              it seems, which made me realize our experience lacked the same
              sense of playfulness and motivation.
            </p>
          </ContentSection>
        </ScrollFade>
        <ScrollFade
        ...
        >
          ...
          >
            ...
            <p>
              Considering the workload required if we were to make a
              visual-heavy game, this felt like the best solution.
            </p>
          </ContentSection>
        </ScrollFade>
        <ScrollFade
        ...
        >
          ...
          >
            <p>
              For this iteration, the most important part was to remove the
              clunk and make it more fun.
            </p>
            <ul>
              <li>
